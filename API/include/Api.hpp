...
public:
    ...
    /// Данный метод может вызвать исключение различных типов. Например InvalidToken.
    ...
    /// Вызов данного метода лучше оборачивать в блок try catch. \n
    /// Данный метод может вызвать исключение различных типов. Например IllegalParamFromDate.
    /// Исключения можно поймать с помощью std::exception.
    ...
    /// Вызов данного метода лучше оборачивать в блок try catch. \n
    /// Данный метод может вызвать исключение различных типов. Например LimitExceeded.
    /// Исключения можно поймать с помощью std::exception.
    ...
    /// Вызов данного метода лучше оборачивать в блок try catch. \n
    /// Данный метод может вызвать исключение различных типов. Например IllegalParams.
    /// Исключения можно поймать с помощью std::exception.
